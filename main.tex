...
a catering team, and a maintenance team. The two bays constrain concurrent
ground handling to at most two aircraft simultaneously; the third aircraft
awaits runway and apron access via the scheduling and landing sub-net before
proceeding to its bay. Each aircraft progresses through three operational
phases as summarised in Table~\ref{tab:phases}.
